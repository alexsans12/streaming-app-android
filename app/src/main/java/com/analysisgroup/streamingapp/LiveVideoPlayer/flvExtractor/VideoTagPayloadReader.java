...
/* package */ final class VideoTagPayloadReader extends TagPayloadReader {
  ...
  protected boolean parseHeader(ParsableByteArray data) throws UnsupportedFormatException {
    ...
    if (videoCodec != VIDEO_CODEC_AVC) {
      ...
      throw new UnsupportedFormatException("Video format not supported: " + videoCodec, throwable, true, 0);
    }
  ...
  protected void parsePayload(ParsableByteArray data, long timeUs) throws ParserException {
    ...
    if (packetType == AVC_PACKET_TYPE_SEQUENCE_HEADER && !hasOutputFormat) {
      ...
      Format format = Format.createVideoSampleFormat(null, MimeTypes.VIDEO_H264, null,
          ...
          avcConfig.initializationData, Format.NO_VALUE, avcConfig.pixelWidthHeightRatio, null);
