...
/* package */ abstract class TagPayloadReader {
  ...
  public static final class UnsupportedFormatException extends ParserException {
    protected UnsupportedFormatException(@Nullable String message, @Nullable Throwable cause, boolean contentIsMalformed, int dataType) {
      super(message, cause, contentIsMalformed, dataType);
    }
  }
