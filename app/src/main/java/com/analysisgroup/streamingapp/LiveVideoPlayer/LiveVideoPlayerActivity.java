 ...
 */
public class LiveVideoPlayerActivity extends AppCompatActivity implements OnClickListener, Player.Listener,
        PlayerControlView.VisibilityListener {

    public static final String PREFER_EXTENSION_DECODERS = "prefer_extension_decoders";

    @SuppressLint("StaticFieldLeak")
    private DefaultBandwidthMeter.Builder BANDWIDTH_METER = new DefaultBandwidthMeter.Builder(getApplicationContext());
    ...
    private PlayerControlView player;
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        return super.dispatchKeyEvent(event) || playerControlView.dispatchMediaKeyEvent(event);
    }
    ...
    private void initializePlayer(String rtmpUrl) {
        ...
        if (needNewPlayer) {
            ...
            TrackSelection.Type videoTrackSelectionFactory =
                    new AdaptiveTrackSelection.Factory(BANDWIDTH_METER.build());
